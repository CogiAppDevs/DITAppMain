...
public class FridayFragment extends Fragment {
    ...
    public static FridayFragment newInstance(int position) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fridayListView = (ListView)view.findViewById(R.id.list);
        tvModuleIcon = (TextView) view.findViewById(R.id.timetable_row_icon);

        firebaseDatabase = FirebaseDatabase.getInstance();
        reference = firebaseDatabase.getReference();

        cacheData = getActivity().getSharedPreferences(getString(R.string.sharedPrefFriday), getContext().MODE_PRIVATE);
    ...
    private void loadTimetable()
    {
        ...
        DatabaseReference uidRef = rootRef.child("timetable").child("friday");
